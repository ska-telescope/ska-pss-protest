Feature: Tests of detection capability of CPU-based FDAS pipeline.
    ...
    @product @cpu @fdas @nasm @all @testvector @mid @labyrinth @nonaccelerated @subset
    ...
    @product @cpu @fdas @all @testvector @mid @labyrinth @nonaccelerated @superset
    ...
    @product @fdas @fpga @all @testvector @mid @accelerated @subset
    ...
    @product @fdas @fpga @all @testvector @mid @accelerated @superset
