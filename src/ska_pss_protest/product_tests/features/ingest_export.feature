@product @cpu @testvector @positive @mid @container @physhw @partial
Feature: Ingest and export of test vector data
    ...
    Scenario Outline: Exporting filterbank data
        ...
        Examples:
        | test_vector                                                       |
        | FDAS-HSUM-MID_38d46df_500.0_0.05_1.0_100.397_Gaussian_50.0_0000_0.0_0.0_123123123.fil |
        | FDAS-HSUM-MID_acf46ab_50.0_0.05_1.0_200.0_Gaussian_50.0_0000_0.0_0.0_123123123.fil    |
