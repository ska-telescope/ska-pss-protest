...
ProTest takes two arguments. The first (-p PATH) is the path to a cheetah build. This can be either of the following
...
To demonstrate, let's run all of the available SPS (Single Pulse Search) tests. We'll use a build tree in this case
